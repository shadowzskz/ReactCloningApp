    ...
    return (
        <div className="sidebar">
            <div className="sidebar__top">
                <SidebarRow 
                    src = {"https://th.bing.com/th/id/OIP.AyVv06KRxDIdsjyaJeD34QAAAA?pid=Api&rs=1"}
                    title = {"Code with Sahaj"}
                />
                <SidebarRow 
            ...
            <div className="sidebar__bottom">
                ...
                <div className="sidebar__bottom_contains">
                    <SidebarRow
                    ...
                    />
                    <SidebarRow 
                        url = "https://th.bing.com/th/id/OIP.AyVv06KRxDIdsjyaJeD34QAAAA?pid=Api&rs=1"
                        title = "Code With Sahaj"
                    />
                    <SidebarRow 
